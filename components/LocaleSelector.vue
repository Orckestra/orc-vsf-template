<template>
  <div class="container">
    ...
    >
      <SfImage :src="`/icons/langs/${locale}.webp`" width="20" height="20" alt="Flag" />
    </SfButton>
    <SfBottomModal
        ...
        <SfListItem v-for="lang in availableLocales" :key="lang.code">
          <a :href="switchLocalePath(lang.code)">
            <SfCharacteristic class="language">
              ...
              <template #icon>
                <SfImage :src="`/icons/langs/${lang.code}.webp`" width="20" height="20"  alt="Flag" class="language__flag" />
              </template>
            </SfCharacteristic>
          </a>
        </SfListItem>
